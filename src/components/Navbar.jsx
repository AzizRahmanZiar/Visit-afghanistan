    ...
    <div className='relative flex flex-wrap z-50 justify-between items-center text-white p-4 border border-slate-700 bg-slate-900'>
      ...
      >
        <li className='focus:text-blue-500'>
          <Link to='/' className='focus:text-blue-500'>
            Home
          </Link>
        </li>
        <li className='focus:text-blue-500'>
          <Link to='/services' className='focus:text-blue-500'>
            Services
          </Link>
        </li>
        <li className='focus:text-blue-500'>
          <Link to='/gallery' className='focus:text-blue-500'>
            Gallery
          </Link>
        </li>
        <li className='focus:text-blue-500'>
          <Link to='/about' className='focus:text-blue-500'>
            About
          </Link>
        </li>
      </ul>
